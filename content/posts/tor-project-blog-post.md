...
Tor’un hikâyesi, teknolojinin nasıl iki ucu keskin bir bıçak olduğunun en büyük kanıtıdır.

---

## Doğduğu Yer: ABD Donanma Araştırma Laboratuvarı
...
## Bugünün Tor’u: Çelişkiler Yumağı

Bugün Tor, hem iyiliğin hem de kötülüğün sığınağıdır:

- **Özgürlük Savaşçıları**: Baskıcı rejimlerde yaşayan gazeteciler, aktivistler ve Snowden gibi ihbarcılar için tek nefes borusudur.
- **Darknet Pazarları**: Silk Road'dan günümüze, her türlü yasa dışı ticaretin yapıldığı o saklı sitelere ( .onion uzantılı siteler) giriş biletidir.

En ilginç detay ise şu: Tor bugün hâlâ büyük oranda ABD hükümeti ve Avrupa Birliği fonlarıyla destekleniyor. Yani devletler, kendi polisine iş çıkaran bu anonimlik ağını, aynı zamanda kendi stratejik çıkarları için finanse etmeye devam ediyor.
